 ...
 * exactly. `rowVersion` is the session's own token — the If-Match value of Pause. `status` is the canonical
 * code (`CHECKED_IN`, `PAUSED`, `CHECKED_OUT`); the UI never sets it, it only reads what the backend returns.
 */
